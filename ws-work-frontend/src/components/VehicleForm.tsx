...
export function VehicleForm() {
  ...
  const handleGenerateDescription = async (e: React.MouseEvent) => {
    ...
    setTimeout(() => {
      setFormData(prev => ({
        ...prev,
        descricao: "Veículo em estado de zero, revisado e com garantia. Excelente oportunidade de negócio gerada por inteligência artificial!"
      }));
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="space-y-1 md:col-span-2">
          ...
          <div className="flex gap-2">
            <input 
              required
              type="text" name="marca" placeholder="Ex: Honda"
            ...
            <input 
              required
              type="text" name="modelo" placeholder="Ex: Civic Touring"
        ...
        <div className="space-y-1">
          ...
          <input 
            required
            type="number" name="ano" placeholder="Ex: 2022"
        ...
        <div className="space-y-1">
          ...
          <input 
            required
            type="text" name="cor" placeholder="Ex: Preto"
        ...
        <div className="space-y-1">
          ...
          <input 
            required
            type="number" name="quilometragem" placeholder="Ex: 45000"
        ...
        <div className="space-y-1">
          ...
          <input 
            required
            type="number" name="valor" placeholder="Ex: 120000"
